var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/jaguar-c-type-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/jaguar-c-type-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/jaguar-c-type-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/jaguar-c-type-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Jaguar C Type?",
				description: "Get awesome Jaguar C Type HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
